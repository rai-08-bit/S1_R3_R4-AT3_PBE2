...
const clienteRepository = {
    criar: async (cliente, telefone, endereco) => {
        ...
        try {
            ...
            console.log('teste', rowsCliente.insertId, endereco.logradouro, endereco.bairro, endereco.numero, endereco.complemento, endereco.cidade, endereco.uf, endereco.cep);
